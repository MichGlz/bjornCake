...
let myIngredients = ['apple', 'butter', 'egg', 'apple', 'milk', 'sugar', 'flour', 'bacon', 'chocolate', 'carrot', 'pear', 'salt'];
...
function title() {
    if(bgsong.muted == true){muteSound();}
    ...
    document.querySelector("#tbuttom_play").addEventListener("click",clickButtomPlay);
   ...
   if (document.querySelector("#title_screen").classList.contains("hide")) 
      ...
      if (gameLoaded==false){ 
        ...
        document.querySelector("#buttom_square").addEventListener("click",loadGame);
        document.querySelector("#buttom_square").addEventListener("click",clickButtomPlay);  
...
function loadGame(){
    bgsoundPlay();
    document.querySelector("#buttom_square").addEventListener("click",clickButtomPlay);
    document.querySelector("#buttom_square").removeEventListener("click",loadGame);
    document.querySelector("#buttom_square").classList.value="";
    document.querySelector("#buttom_square").offsetHeight;
    ...
    if (bearSteps==false){stepsSound.play();}
    document.querySelector("#play_bee").classList.add("fly3");
    document.querySelector("#play_bee").addEventListener("animationend", flyBee);
    document.querySelector("#buttom_square").addEventListener("click", instructionsScreen);
    stepsSound.addEventListener("ended", () => {bearSteps=true;});
    gameLoaded=true;
...
function flyBee() {
    ...
    document.querySelector("#play_bee").removeEventListener("animationend", flyBee);
    document.querySelector("#play_bee").offsetHeight;
}

function instructionsScreen() {
    document.querySelector("#inst_but_play").addEventListener("click", clickButtomPlay);
    ...
    document.querySelector("#buttom_square").removeEventListener("click", instructionsScreen);
    if (gameEnded == false) {
    ...
    document.querySelector("#close_buttom").addEventListener("click", clickButtomPlay);
...
function start() {
    ...
    document.querySelector("#bee_1_container").addEventListener("animationiteration", newDuration);
    document.querySelector("#bee_1_container").addEventListener("animationstart", bzzzPlay);
    ...
    document.querySelector("#bee_2_container").addEventListener("animationiteration", newDuration);
    document.querySelector("#bee_2_container").addEventListener("animationstart", bzzzPlay);
    ...
    document.querySelector("#bee_3_container").addEventListener("animationiteration", newDuration);
    document.querySelector("#bee_3_container").addEventListener("animationstart", bzzzPlay);
    ...
    document.querySelector("#bee_4_container").addEventListener("animationiteration", newDuration);
    document.querySelector("#bee_4_container").addEventListener("animationstart", bzzzPlay);
    ...
    document.querySelector("#bee_5_container").addEventListener("animationiteration", newDuration);
    document.querySelector("#bee_5_container").addEventListener("animationstart", bzzzPlay);
    ...
    document.querySelector("#container1").addEventListener("animationiteration", newGoodSprite);
    ...
    document.querySelector("#container2").addEventListener("animationiteration", newGoodSprite);
    ...
    document.querySelector("#container3").addEventListener("animationiteration", newGoodSprite);
    ...
    document.querySelector("#container4").addEventListener("animationiteration", newGoodSprite);
    ...
    document.querySelector("#container5").addEventListener("animationiteration", newGoodSprite);
    ...
    document.querySelector("#container6").addEventListener("animationiteration", newGoodSprite);
    ...
    document.querySelector("#container7").addEventListener("animationiteration", newGoodSprite);
    ...
    document.querySelector("#container8").addEventListener("animationiteration", newGoodSprite);
    ...
    document.querySelector("#container9").addEventListener("animationiteration", newGoodSprite);
    ...
    document.querySelector("#container10").addEventListener("animationiteration", newGoodSprite);
    ...
    document.querySelector("#container11").addEventListener("animationiteration", newGoodSprite);
    ...
    document.querySelector("#goreplay").addEventListener("click", clickButtomPlay);
    document.querySelector("#toreplay").addEventListener("click", replay);
    document.querySelector("#toreplay").addEventListener("click", clickButtomPlay);
    document.querySelector("#lcreplay").addEventListener("click", replay);
    document.querySelector("#lcreplay").addEventListener("click", clickButtomPlay);
    ...
    document.querySelector("#container1").addEventListener("animationstart", popPlay);
    document.querySelector("#container2").addEventListener("animationstart", popPlay);
    document.querySelector("#container3").addEventListener("animationstart", popPlay);
    document.querySelector("#container4").addEventListener("animationstart", popPlay);
    document.querySelector("#container5").addEventListener("animationstart", popPlay);
    document.querySelector("#container6").addEventListener("animationstart", popPlay);
    document.querySelector("#container7").addEventListener("animationstart", popPlay);
    document.querySelector("#container8").addEventListener("animationstart", popPlay);
    document.querySelector("#container9").addEventListener("animationstart", popPlay);
    document.querySelector("#container10").addEventListener("animationstart", popPlay);
    document.querySelector("#container11").addEventListener("animationstart", popPlay);
...
function newGoodSprite() {
    ...
    let ingredient = myIngredients[Math.floor(Math.random() * myIngredients.length)];
...
function good() {
    ...
    if (this.classList.contains('flour')) {
        if (noFlour <= (listFlour - 1)) {
            this.classList.add("scale");
            superDuper();
            noFlour++;
            document.querySelector("#cflour").textContent = noFlour;
            
            if (noFlour == listFlour) {
                this.textContent = "Done";
                                
            } else {
                this.textContent = listFlour - noFlour;
            }
        ...
        if (noFlour == listFlour) {
            ...
            document.querySelector("#xflour").classList.add("mark");
            document.querySelector("#xflour").classList.remove("hide");
            list++;
    ...
    } else if (this.classList.contains('sugar')) {
        if (noSugar <= (listSugar - 1)) {
            this.classList.add("scale");
            superDuper();
            noSugar++;
            document.querySelector("#csugar").textContent = noSugar;
            
            if (noSugar == listSugar) {
                this.textContent = "Done";
            } else {
                this.textContent = listSugar - noSugar;
            }
        }
        if (noSugar == listSugar) {
            noSugar++;
            ...
            this.offsetHeight;
            this.classList.add("scale2");
            document.querySelector("#xsugar").classList.add("mark");
            document.querySelector("#xsugar").classList.remove("hide");
            list++;
        }
        if (noSugar > listSugar) {
            this.classList.add("turn");
    ...
    } else if (this.classList.contains('milk')) {
        if (noMilk <= (listMilk - 1)) {
            this.classList.add("scale");
            superDuper();
            noMilk++;
            document.querySelector("#cmilk").textContent = noMilk;
            if (noMilk == listMilk) {
                this.textContent = "Done";
            } else {
                this.textContent = listMilk - noMilk;
            }
        ...
        if (noMilk == listMilk) {
            ...
            this.offsetHeight;
            this.classList.add("scale2");
            document.querySelector("#xmilk").classList.add("mark");
            document.querySelector("#xmilk").classList.remove("hide");
            list++;
        }
        if (noMilk > listMilk) {
            this.classList.add("turn");
    ...
    } else if (this.classList.contains('butter')) {
        if (noButter <= (listButter - 1)) {
            this.classList.add("scale");
            superDuper();
            noButter++;
            document.querySelector("#cbutter").textContent = noButter;
            if (noButter == listButter) {
                this.textContent = "Done";
            } else {
                this.textContent = listButter - noButter;
            }
        }
        if (noButter == listButter) {
            noButter++;
            ...
            this.offsetHeight;
            this.classList.add("scale2");
            document.querySelector("#xbutter").classList.add("mark");
            document.querySelector("#xbutter").classList.remove("hide");
            list++;
        }
        if (noButter > listButter) {
            this.classList.add("turn");
        ...
        if (noApple <= (listApple - 1)) {
            this.classList.add("scale");
            superDuper();
            noApple++;
            document.querySelector("#capple").textContent = noApple;
            if (noApple == listApple) {
                this.textContent = "Done";
            } else {
                this.textContent = listApple - noApple;
            }
        }
        ...
        if (noApple == listApple) {
            ...
            this.offsetHeight;
            this.classList.add("scale2");
            document.querySelector("#xapple").classList.add("mark");
            document.querySelector("#xapple").classList.remove("hide");
            list++;
        }
        if (noApple > listApple) {
            this.classList.add("turn");
    ...
    } else if (this.classList.contains('egg')) {
        if (noEgg <= (listEgg - 1)) {
            this.classList.add("scale");
            superDuper();
            noEgg++;
            document.querySelector("#cegg").textContent = noEgg;
            if (noEgg == listEgg) {
                this.textContent = "Done";
            } else {
                this.textContent = listEgg - noEgg;
            }
        }
        if (noEgg == listEgg) {
            noEgg++;
            ...
            this.offsetHeight;
            this.classList.add("scale2");
            document.querySelector("#xegg").classList.add("mark");
            document.querySelector("#xegg").classList.remove("hide");
            list++;
        }
        if (noEgg > listEgg) {
            this.classList.add("turn");
...
function pauseGame() {
    ...
    if (gameIsPaused == false) {
        ...
        bgsong.pause();
        bzzz.pause();
        if (caida.currentTime>0){caida.pause();} 
        tictac.pause();
        ...
        document.querySelector("#bee_1_container").removeEventListener("animationiteration", newDuration);
        document.querySelector("#bee_2_sprite").removeEventListener("click", diy1);
        document.querySelector("#bee_2_container").removeEventListener("animationiteration", newDuration);
        document.querySelector("#bee_3_sprite").removeEventListener("click", diy1);
        document.querySelector("#bee_3_container").removeEventListener("animationiteration", newDuration);
        document.querySelector("#bee_4_sprite").removeEventListener("click", diy1);
        document.querySelector("#bee_4_container").removeEventListener("animationiteration", newDuration);
        document.querySelector("#bee_5_sprite").removeEventListener("click", diy1);
        document.querySelector("#bee_5_container").removeEventListener("animationiteration", newDuration);


        document.querySelector("#sprite1").removeEventListener("click", good);
        document.querySelector("#container1").removeEventListener("animationiteration", newGoodSprite);
        document.querySelector("#sprite2").removeEventListener("click", good);
        document.querySelector("#container2").removeEventListener("animationiteration", newGoodSprite);
        document.querySelector("#sprite3").removeEventListener("click", good);
        document.querySelector("#container3").removeEventListener("animationiteration", newGoodSprite);
        document.querySelector("#sprite4").removeEventListener("click", good);
        document.querySelector("#container4").removeEventListener("animationiteration", newGoodSprite);
        document.querySelector("#sprite5").removeEventListener("click", good);
        document.querySelector("#container5").removeEventListener("animationiteration", newGoodSprite);
        document.querySelector("#sprite6").removeEventListener("click", good);
        document.querySelector("#container6").removeEventListener("animationiteration", newGoodSprite);
        document.querySelector("#sprite7").removeEventListener("click", good);
        document.querySelector("#container7").removeEventListener("animationiteration", newGoodSprite);
        document.querySelector("#sprite8").removeEventListener("click", good);
        document.querySelector("#container8").removeEventListener("animationiteration", newGoodSprite);
        document.querySelector("#sprite9").removeEventListener("click", good);
        document.querySelector("#container9").removeEventListener("animationiteration", newGoodSprite);
        document.querySelector("#sprite10").removeEventListener("click", good);
        document.querySelector("#container10").removeEventListener("animationiteration", newGoodSprite);
        document.querySelector("#sprite11").removeEventListener("click", good);
        document.querySelector("#container11").removeEventListener("animationiteration", newGoodSprite);
        ...
        if (timeLeft < 20) {tictac.play();}
        if (caida.currentTime>0){caida.play();} 
        document.querySelector("#pause").classList.remove("button_play");
        document.querySelector("#pause").classList.add("button_pause");
...
function alarm(){
    ...
    document.querySelector("#alarm").addEventListener("animationend", function(){document.querySelector("#alarm").classList.remove("alarma");} );
}
